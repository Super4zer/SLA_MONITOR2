...
<style>
  ...
  /* Sub-menu langsung (tanpa flyout) - seperti menu Magang */
  .dropmenudiv_e .submenu-item a {
    display: block;
    text-indent: 5px;
    font: bold 12px Verdana;
    border: 0 solid #657f27;
  ...
  .dropmenudiv_e .submenu-item a:hover {
    background-color: #4AFFFF;
  }
</style>
...
<body>
    ...
    if (empty($hak_akses_user)) {
      ...
      if ($checkMaster->rowCount() > 0) {
        ...
        foreach ($masterMenus as $m) {
          if ($kodjab != 1 && in_array($m, $hidden_staff_menus))
            continue;
  ...
  function cek_akses($menu, $hak_akses_user)
  {
    ...
    if (!isset($hak_akses_user[$menu])) {
      // No record = default depends on staff vs admin/GM
      ...
      if (in_array($menu, $default_off_staff)) {
        return false;
      }
      return true;
    }
...
$show_produksi = (
  ...
  // Check if Marketing tab should be shown
  $show_marketing = (
    cek_akses('Letter Code', $hak_akses_user) ||
    cek_akses('Payment Invoice', $hak_akses_user) ||
    cek_akses('Tax Invoice', $hak_akses_user) ||
    cek_akses('Client List', $hak_akses_user) ||
    cek_akses('Minutes of Meeting', $hak_akses_user) ||
    cek_akses('Implementasi', $hak_akses_user) ||
    cek_akses('Clients File', $hak_akses_user) ||
    cek_akses('Content Plan', $hak_akses_user) ||
    cek_akses('Supporting Task', $hak_akses_user) ||
    cek_akses('List Prospek', $hak_akses_user) ||
    cek_akses('Outstanding Payment', $hak_akses_user) ||
    cek_akses('Revenue Growth', $hak_akses_user) ||
    cek_akses('Sales Pipeline', $hak_akses_user) ||
    cek_akses('Implementation Progress', $hak_akses_user) ||
    cek_akses('Tasking Log', $hak_akses_user)
  );
  ?>
  ...
  <div id="moonmenu" class="halfmoon">
    <ul>
      ...
      <?php // ========== MENU MARKETING ========== ?>
      <?php if ($show_marketing || cek_akses('Implementasi', $hak_akses_user)) { ?>
        <li><a href=# rel=dropmenu6_e>Marketing</a></li>
      <?php } ?>

      <?php // ========== MENU SLA MONITORING ========== ?>
      <li><a href=# rel=dropmenu_sla>SLA Monitoring</a></li>

      <?php // ========== KALENDER ========== ?>
      <?php if (cek_akses('Kalender', $hak_akses_user)) { ?>
        <li><a href="index.php?par=47">Kalender</a></li>
      <?php } ?>

      <?php // ========== MAGANG ========== ?>
      <!-- <li><a href="#" rel="dropmenu_magang">Magang</a></li> -->

      <?php if (cek_akses('Minutes of Meeting', $hak_akses_user)) { ?>
        <li><a href='index.php?par=59'>Minutes of Meeting</a></li>
      <?php } ?>
    </ul>
  </div>
    ...
    <div id='dropmenu_pengaturan' class='dropmenudiv_e' style='width: 170px;' align='left'>
      ...
      <?php if ($kodjab == 1 || $kodjab == 2) { ?>
        <div class="has-submenu">
          ...
          <div class="submenu">
            ...
            <a href="index.php?par=72">Input User Client</a>
          </div>
        </div>
      <?php } ?>
      ...
      <?php ?>
        <div class="has-submenu">
          <a href="#">Magang</a>
          <div class="submenu">
            <a href="index.php?par=70">Pengajuan Magang</a>
            <a href="index.php?par=71">Daftar Siswa Magang</a>
          </div>
        </div>
      <?php ?>

      <?php if ($kodjab == 1 || $kodjab == 2) { ?>
        <a href="index.php?par=73"
          style="display: block; text-indent: 5px; font: bold 12px Verdana; border: 0 solid #657f27; border-bottom-width: 1px; padding: 4px 5px; text-decoration: none; color: #000; background-color: #b8e6ff;">Setting Poin</a>
      <?php } ?>

      <?php if (cek_akses('About', $hak_akses_user)) { ?>
        <a href="index.php?par=42"
          style="display: block; text-indent: 5px; font: bold 12px Verdana; border: 0 solid #657f27; border-bottom-width: 1px; padding: 4px 5px; text-decoration: none; color: #000; background-color: #b8e6ff;">About</a>
      <?php } ?>
  ...
  <?php
  if ($show_marketing || cek_akses('Implementasi', $hak_akses_user)) {
    ?>
    <div id='dropmenu6_e' class='dropmenudiv_e' style='width: 170px;' align='left'>
      <?php if (cek_akses('Letter Code', $hak_akses_user) || cek_akses('Payment Invoice', $hak_akses_user) || cek_akses('Tax Invoice', $hak_akses_user) || cek_akses('Client List', $hak_akses_user) || cek_akses('Minutes of Meeting', $hak_akses_user)) { ?>
        <div class="has-submenu">
          <a href="#">Administration</a>
          <div class="submenu">
            <?php if (cek_akses('Letter Code', $hak_akses_user)) { ?>
              <a href='index.php?par=56'>Letter Code</a>
            <?php } ?>
            <?php if (cek_akses('Payment Invoice', $hak_akses_user)) { ?>
              <a href='index.php?par=09'>Payment Invoice</a>
            <?php } ?>
            <?php if (cek_akses('Tax Invoice', $hak_akses_user)) { ?>
              <a href='index.php?par=11'>Tax Invoice</a>
            <?php } ?>

            <?php if (cek_akses('Client List', $hak_akses_user)) { ?>
              <a href="index.php?par=06">Client List</a>
            <?php } ?>
          </div>
        </div>
      <?php } ?>
      <?php if (cek_akses('Content Plan', $hak_akses_user) || cek_akses('Supporting Task', $hak_akses_user) || cek_akses('Implementasi', $hak_akses_user) || cek_akses('Clients File', $hak_akses_user)) { ?>
        <div class="has-submenu">
          <a href="#">Tasking</a>
          <div class="submenu">
            <?php if (cek_akses('Content Plan', $hak_akses_user)) { ?>
              <a href='index.php?par=57'>Content Plan</a>
            <?php } ?>

            <?php if (cek_akses('Supporting Task', $hak_akses_user)) { ?>
              <a href='index.php?par=58'>Supporting Task</a>
            <?php } ?>

            <?php if (cek_akses('Implementasi', $hak_akses_user)) { ?>
              <a href="index.php?par=69">Implementation Check</a>
            <?php } ?>

            <?php if (cek_akses('Clients File', $hak_akses_user)) { ?>
              <a href='index.php?par=60'>Client File</a>
            <?php } ?>

            <?php /* HIDDEN: Implementasi lama sudah tidak digunakan, digantikan Implementation Check
            <?php if (cek_akses('Implementasi', $hak_akses_user)) { ?>
              <div class="has-submenu">
      ...
      <?php } ?>
      <?php if (cek_akses('List Prospek', $hak_akses_user) || cek_akses('Outstanding Payment', $hak_akses_user)) { ?>
        <div class="has-submenu">
          <a href="#">Selling</a>
          <div class="submenu">
            <?php if (cek_akses('List Prospek', $hak_akses_user)) { ?>
              <a href='index.php?par=61'>Prospect List</a>
            <?php } ?>
            <?php if (cek_akses('Outstanding Payment', $hak_akses_user)) { ?>
              <a href="index.php?par=63">Outstanding Payment</a>
            <?php } ?>
          </div>
        </div>
      <?php } ?>
      <?php if (cek_akses('Revenue Growth', $hak_akses_user) || cek_akses('Sales Pipeline', $hak_akses_user) || cek_akses('Implementation Progress', $hak_akses_user) || cek_akses('Tasking Log', $hak_akses_user)) { ?>
        <div class="has-submenu">
          <a href="#">Report Summary</a>
          <div class="submenu">
            <?php if (cek_akses('Revenue Growth', $hak_akses_user)) { ?>
              <a href='index.php?par=62'>Revenue Growth</a>
            <?php } ?>
            <?php if (cek_akses('Sales Pipeline', $hak_akses_user)) { ?>
              <a href='index.php?par=64'>Sales Pipeline</a>
            <?php } ?>
            <?php if (cek_akses('Implementation Progress', $hak_akses_user)) { ?>
              <a href='index.php?par=68'>Implementation Progress</a>
            <?php } ?>
            <?php if (cek_akses('Tasking Log', $hak_akses_user)) { ?>
              <a href='index.php?par=65'>Tasking Log</a>
            <?php } ?>
          </div>
        </div>
      <?php } ?>
  ...
  <?php if ($show_produksi) { ?>
    <div id='dropmenu_produksi' class='dropmenudiv_e' style='width: 170px;' align='left'>
      ...
      <?php if (cek_akses('Log', $hak_akses_user)) { ?>
        <div class="has-submenu">
          ...
          <div class="submenu">
            ...
            <a href='index.php?par=76'>Create Log CS</a>
      ...
      <?php if (cek_akses('Laporan Log', $hak_akses_user)) { ?>
        <div class="has-submenu">
          ...
          <div class="submenu">
            ...
            <a href='index.php?par=77'>Laporan Log CS</a>
            <a href='index.php?par=74'>Laporan Poin Log</a>
            <?php /* 
      ...
      <?php if ($kodjab == 1 || $kodjab == 2 || $kodjab == 3 || $kodjab == 4 || cek_akses('Password Manager', $hak_akses_user)) { ?>
        <a href='index.php?par=75' 
        style="display: block; text-indent: 5px; font: bold 12px Verdana; border: 0 solid #657f27; border-bottom-width: 1px; padding: 4px 5px; text-decoration: none; color: #000; background-color: #b8e6ff;">Password Manager</a>
      <?php } ?>
  ...
  <?php if ($show_keuangan) { ?>
    <div id='dropmenu_keuangan_group' class='dropmenudiv_e' style='width: 170px;' align='left'>
      ...
      <!-- === HIDDEN: Invoice sekarang diakses via Marketing > Administration > Payment Invoice ===
      <?php if (false && cek_akses('Invoice', $hak_akses_user)) { ?>
        <div class="has-submenu">
          <a href="#">Invoice</a>
          <div class="submenu">
      ...
      <?php if (false && cek_akses('Laporan Invoice', $hak_akses_user)) { ?>
        <div class="has-submenu">
      ...
      <?php if (cek_akses('Keuangan', $hak_akses_user)) { ?>
        <div class="has-submenu">
          ...
          <div class="submenu">
            ...
            <!-- <a href='index.php?par=40a'>Kelola Kantong</a> -->
            <a href='index.php?par=41'>Laporan Arus Kas</a>
            <a href='index.php?par=41b'>Mutasi Kantong</a>
          </div>
        </div>
      <?php } ?>
  ...
  <?php // ========== DROPDOWN: SLA MONITORING ========== ?>
  <div id='dropmenu_sla' class='dropmenudiv_e' style='width: 180px;' align='left'>
  ...
  <?php // ========== DROPDOWN: MAGANG ========== ?>
  <!-- <div id='dropmenu_magang' class='dropmenudiv_e' style='width: 180px;' align='left'>
    <div class="submenu-item"><a href="index.php?par=70">Pengajuan Magang</a></div>
    <div class="submenu-item"><a href="index.php?par=71">Daftar Siswa Magang</a></div>
  </div> -->
